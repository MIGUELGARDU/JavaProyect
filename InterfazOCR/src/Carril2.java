...
{
    private JPanel Carrill2;
    private Paint2 image;
    private Paint2p imagep;
    
    public Carril2() throws IOException
    {
        buildGUI() ;
    }
    ...
    {
        Carrill2 = new JPanel();
        Carrill2.setPreferredSize(new Dimension(400,550));
        image = new Paint2(new ImageIcon("figs/320x240.gif").getImage());
        imagep = new Paint2p(new ImageIcon("figs/320x240.gif").getImage());
        ...
        c.gridwidth = 6;
        c.gridheight = 8;
        Carrill2.add(image,c);
        c.gridx = 1;
        c.gridy = 20;
        c.gridwidth = 8;
        c.gridheight = 6;
        Carrill2.add(imagep,c);
        VentanaPrincipal.Carriles.addTab("Carril 2",Carrill2);
    ...
    private void start()
    {
        if(beging ==false)
        {
            video = new VideoCapture(LeerConfiguracion.Carril2);
