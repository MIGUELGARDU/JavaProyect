...
public class Carril4
{
    private JPanel Carrill4;
    private Paint4 image;
    private Paint4p imagep;
    
    public Carril4() throws IOException
    {
        buildGUI() ;
    }
    ...
    {
        Carrill4= new JPanel();
        Carrill4.setPreferredSize(new Dimension(400,550));
        image = new Paint4(new ImageIcon("figs/320x240.gif").getImage());
        imagep = new Paint4p(new ImageIcon("figs/320x240.gif").getImage());
        ...
        c.gridwidth = 6;
        c.gridheight = 8;
        Carrill4.add(image,c);
        c.gridx = 1;
        c.gridy = 20;
        c.gridwidth = 8;
        c.gridheight = 6;
        Carrill4.add(imagep,c);
        VentanaPrincipal.Carriles.addTab("Carril 4",Carrill4);
    ...
    private void start()
    {
        if(beging ==false)
        {
            video = new VideoCapture(LeerConfiguracion.Carril4);
